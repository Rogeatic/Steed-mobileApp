        ...
        pages={[
            {
              ...
              title: <Text style={{fontWeight:'bold', fontSize: 19, margin:15, textAlign:'center', color:'#A0CE4E', margin:12,  marginTop: -130}}>Stedi Mobile</Text>,
              subtitle: (
                <View>  
                <Text style={{fontWeight:'bold', textAlign:'center', color:'#A0CE4E', fontSize:19, margin:12,  marginTop: -70}}>We Value Your Privacy.</Text>
                </View>
